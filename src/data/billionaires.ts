...
export const billionaires: Billionaire[] = [
  ...
  },
  {
    ...
    bio: "Co-founder and CEO of Coinbase, the largest cryptocurrency exchange in the United States. His stake of roughly 14% carries majority voting control through Coinbase's dual-class share structure.",
    wikipediaTitle: "Brian_Armstrong_(businessman)",
    ticker: "COIN",
    sharesHeld: 23_500_000,
    otherAssetsUsd: 1_000_000_000,
  },
  {
    id: "michael-saylor",
    ...
    gender: "male",
    country: "United States",
    primarySource: "Strategy (MicroStrategy)",
    industry: "Cryptocurrency",
    birthDate: "1965-02-04",
    bio: "Executive chairman of Strategy (formerly MicroStrategy), the largest corporate holder of bitcoin. Also personally owns roughly 17,700 bitcoin bought before the company's treasury program began.",
    wikipediaTitle: "Michael_J._Saylor",
    ticker: "MSTR",
    sharesHeld: 19_600_000,
    otherAssetsUsd: 1_300_000_000,
  },
  {
    id: "changpeng-zhao",
    name: "Changpeng Zhao",
    ...
    bio: "Founder and former CEO of Binance, the world's largest cryptocurrency exchange. Chinese-born Canadian citizen who is based in Dubai. Often ranked as the richest Canadian.",
  ...
  },
  {
    ...
    bio: "Founder of the messaging app Telegram, which he runs from Dubai. Russian-born, he holds Emirati, French, Russian, and St. Kitts citizenship. His net worth is uncertain because Telegram is privately held.",
